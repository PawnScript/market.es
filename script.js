...
// Función para verificar la URL y mostrar el contenido apropiado
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    checkUrlAndShowContent();
    
    // Elementos del DOM (página principal)
    ...
    // Elementos del DOM (panel de administración)
        ...
        if (username === ADMIN_CREDENTIALS.username && password === ADMIN_CREDENTIALS.password) {
            ...
            adminStats.innerHTML = `
                <div class="order-item">
                    <div class="order-item-main">
                        <div class="item-label"><i class="fas fa-shopping-cart"></i> Pedidos Totales</div>
                        <div class="item-value">24</div>
                    </div>
                    <div class="item-price">$480.50</div>
                </div>
                <div class="order-item">
                    <div class="order-item-main">
                        <div class="item-label"><i class="fas fa-check-circle"></i> Pedidos Completados</div>
                        <div class="item-value">18</div>
                    </div>
                    <div class="item-price">$360.75</div>
                </div>
                <div class="order-item">
                    <div class="order-item-main">
                        <div class="item-label"><i class="fas fa-clock"></i> Pedidos Pendientes</div>
                        <div class="item-value">6</div>
                    </div>
                    <div class="item-price">$119.75</div>
                </div>
            `;
        } else {
            // Login fallido
    ...
    // Función para ver pedidos (simulada)
    function handleViewOrders() {
        alert('Funcionalidad de ver pedidos aún en desarrollo. Será implementada en la siguiente actualización.');
    }
    
    // Event listeners para página principal
    ...
    // Event listeners para panel de administración
    if (adminLoginForm) {
    ...
    if (validateDescription) validateDescription();
    
    // Inicializar precio del tiempo
    if (updateTimePrice) updateTimePrice();
});